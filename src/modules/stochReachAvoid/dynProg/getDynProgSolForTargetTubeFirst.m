function [prob_x, cell_of_xvec, varargout] = getDynProgSolForTargetTubeFirst(sys, x_inc, u_inc,...
    safety_tube, target_set)
...
%   target_set  - Target set that needs to be reached at some point within
%                 the horizon
%   
%   
%
...
%        https://github.com/unm-hscl/SReachTools/blob/master/LICENSE
    ...
    validateattributes(safety_tube, {'TargetTube'}, {'nonempty'});
    ...
    for itt = n_targets - 1:-1:1
        ...
        % Iterate over the rest of the points that are safe
