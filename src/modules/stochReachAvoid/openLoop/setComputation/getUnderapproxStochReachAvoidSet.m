...
%   init_safe_set        - Safe set for initial state (after intersection with
%                           the affine hull of the set_of_direction_vectors)                          
%   prob_thresh_of_interest 
...
%
    ...
    switch(lower(method))
        case 'ccc'
            ...
            piecewise_count = 1e3;
            [invcdf_approx_A, invcdf_approx_b, lb_deltai] =...
                ...
                for direction_index = 1: no_of_direction_vectors
                    ...
                    cvx_begin quiet
                        ...
                        subject to
                            ...
                            % constraints
                            concat_target_tube_A * mean_X + sigma_vector *...
                                norminvover<= concat_target_tube_b;
                            % (4) Lower bound on delta due to pwl's domain
                            deltai >= lb_deltai;
        ...
        case 'genzps'
            ...
            elseif isempty(varargin) == 1
                ...
                error('SReachTools:invalidArgs', ...
                      ['desired_accuracy and PSoptions together are the ', ...
            ...
            if max_underapprox_reach_avoid_prob <...
                ...
                for direction_index = 1: no_of_direction_vectors
                    ...
                    [opt_theta_i(direction_index), ...
                     ...
                     opt_reachAvoid_i(direction_index)] = ...
        ...
        otherwise
            error('SReachTools:invalidArgs', ...
                  ['Unsupported method requested in ',...
                   'getUnderapproxStochReachAvoidSet.']);
    end
    varargout{1} = xmax;
...
%else
    ...
    %while (theta_upper - theta_lower) > tol_bisection
        ...
        %% Recompute the opt value just to be sure
        %revaluate_opt_prob =...
