...
%
    ...
    concat_optimal_input_vector = zeros(time_horizon * sys.input_dim, n_monte_carlo_sims);
    optimal_input_dist_gain = zeros(time_horizon * sys.input_dim, time_horizon * sys.dist_dim);
    if sys.input_dim > 0
        if nargin >= 5
            ...
            if nargin == 6
                ...
                assert(ismatrix(optimal_input_dist_gain) &&...
                       all(size(optimal_input_dist_gain) == ...
                            [time_horizon * sys.input_dim, time_horizon * sys.dist_dim]), ...
                       'SReachTools:invalidArgs', ...
