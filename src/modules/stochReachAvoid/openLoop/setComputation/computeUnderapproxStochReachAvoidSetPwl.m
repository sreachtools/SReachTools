function [underapprox_stoch_reach_avoid_polytope, ...
    ...
    % subject to
    %   W_0(x,U) >= probability_threshold_of_interest 
    ...
    cvx_begin quiet
        ...
        subject to
            % Chance-constraint reformulation of the safety probability (1-6)
    ...
    if strcmpi(cvx_status, 'Solved')
        ...
        % least one x for which W(x,U)= probability_threshold_of_interest, then
    ...
    if max_underapprox_reach_avoid_prob < probability_threshold_of_interest
        ...
        optimal_theta_i = nan(1, no_of_direction_vectors);
        optimal_reachAvoid_i = nan(1, no_of_direction_vectors);
        optimal_input_vector_at_boundary_points =...
        ...
        for direction_index = 1: no_of_direction_vectors
            ...
            %   W_0( boundary_point, U) >= probability_threshold_of_interest 
            ...
            cvx_begin quiet
                ...
                subject to
                    ...
                    % Chance-constraint reformulation of safety probability(1-6)
