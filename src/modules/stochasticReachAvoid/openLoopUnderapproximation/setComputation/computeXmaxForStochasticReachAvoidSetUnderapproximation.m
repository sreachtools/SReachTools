...
% computeXmaxForStochasticReachAvoidSetUnderapproximation: Computes the maximum
% attainable stochastic reach-avoid probability using open-loop controllers
% (Internal function --- assumes arguments are all ok)
% ====================================================================================
%
% computeXmaxForStochasticReachAvoidSetUnderapproximation computes the initial
...
%
    ...
    % maximize R - 0.01 |U| 
    % subject to
    %   X = Abar x_0 + H_matrix * U + G_matrix * \mu_W 
    %   U \in \mathcal{U}^N
    ...
    cvx_begin quiet
        ...
        subject to
            ...
            resulting_X_for_xmax == (Abar * initial_x_for_xmax ...
                            + H_matrix * guess_concatentated_input_vector...
                            + mean_X_sans_input_sans_initial_state)
    ...
    negativeLogReachAvoidProbabilityGivenInputVectorInitialState =...
      ...
      -log(reachAvoidProbabilityAssumingValidInitialState(...
    ...
    input_vector_augmented_safe_Aineq = blkdiag(concatenated_input_space_A,...
                                                safe_set.A);
    input_vector_augmented_safe_bineq = [concatenated_input_space_b;
                                         safe_set.b];
