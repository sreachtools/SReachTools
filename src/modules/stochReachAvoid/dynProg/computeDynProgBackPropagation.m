...
% 
    ...
    mu = sys.state_matrix * state_vec + ...
        sys.input_matrix * input_vec + ...
        sys.disturbance_matrix * sys.disturbance.parameters.mean;
    
    % variance after state transition
    sigma = sys.disturbance_matrix * sys.disturbance.parameters.covariance * ...
        sys.disturbance_matrix';
