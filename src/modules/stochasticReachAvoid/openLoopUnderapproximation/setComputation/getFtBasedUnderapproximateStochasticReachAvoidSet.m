function [underapproximate_stochastic_reach_avoid_polytope,...
          ...
          getFtBasedUnderapproximateStochasticReachAvoidSet(...
                                           ...
                                           varargin)
% SReach/stochasticReachAvoid/getFtBasedUnderapproximateStochasticReachAvoidSet: 
...
% =============================================================================
%
% getFtBasedUnderapproximateStochasticReachAvoidSet computes the open-loop
% controller-based underapproximative stochastic reach-avoid set  to the
% terminal hitting-time stochastic reach-avoid problem discussed in
%
...
% * maximum_underapproximate_reach_avoid_probability is the highest threshold
...
%
    ...
    % Compute H_matrix, mean_X_sans_input, covariance_X_sans_input, Abar,
    % G_matrix. See @LtiSystem\getConcatMats for the notation.
    % GUARANTEES: Gaussian-perturbed LTI system (sys)
    [H_matrix, mean_X_sans_input_sans_initial_state, covariance_X_sans_input,...
     Abar, G_matrix] =...
       getHmatMeanCovForXSansInput(sys,...
                                                zeros(sys.state_dimension,1),...
                                                time_horizon);
    ...
    [maximum_underapproximate_reach_avoid_probability,...
     xmax,...
     optimal_input_vector_for_xmax] =...
         computeXmaxForStochasticReachAvoidSetUnderapproximation(...
                                        sys,...
                                        time_horizon,...
                                        safe_set,...
    ...
    if maximum_underapproximate_reach_avoid_probability <...
        probability_threshold_of_interest
        ...
        underapproximate_stochastic_reach_avoid_polytope = Polyhedron();
        ...
        %% Construction of underapproximate_stochastic_reach_avoid_polytope
        ...
        underapproximate_stochastic_reach_avoid_polytope = Polyhedron('V',...
    ...
    varargout{3} = maximum_underapproximate_reach_avoid_probability;
...
%minVRep(underapproximate_stochastic_reach_avoid_polytope);
%no_of_vertices_left =...
%             size(underapproximate_stochastic_reach_avoid_polytope.V,1);
